...
function AccessDenied() {
  return (
    <div className='access-denied'>
      <div className='icon'>
        <svg x='0px' y='0px' viewBox='0 0 512 512' height='150px' width='150px' style={{ enableBackground: 'new 0 0 512 512' }}>
          <path
            style={{ fill: '#495A79' }}
            d='M501.461,383.799L320.501,51.401C306.7,28.6,282.7,14.8,256,14.8s-50.7,13.8-64.501,36.601
	...
	c27.301,0,51.601-14.101,65.099-37.8C515.56,435.701,515.259,407.501,501.461,383.799z'
          ...
          <path
            style={{ fill: '#42516D' }}
            d='M502.059,459.4c-13.499,23.699-37.798,37.8-65.099,37.8H256V14.8c26.7,0,50.7,13.801,64.501,36.601
	L501.461,383.8C515.259,407.501,515.56,435.701,502.059,459.4z'
          />
          <path
            style={{ fill: '#FFDE33' }}
            d='M475.661,399.1L294.699,66.699C286.601,52.9,271.901,44.8,256,44.8s-30.601,8.101-38.699,21.899
	...
	C484.06,430.299,484.06,413.201,475.661,399.1z'
          ...
          <path
            style={{ fill: '#FFBC33' }}
            d='M475.96,444.4c-8.099,14.399-22.798,22.8-39,22.8H256V44.8c15.901,0,30.601,8.101,38.699,21.899
	L475.661,399.1C484.06,413.201,484.06,430.299,475.96,444.4z'
          ...
          <g>
            ...
            <path
              style={{ fill: '#495A79' }}
              d='M286,317.2c0,16.538-13.462,30-30,30s-30-13.462-30-30v-150c0-16.538,13.462-30,30-30
      ...
      <h1 className='denied-text'>Access Denied !</h1>
      <div className='denied-para'>You currently do not have access to this page.</div>
      <div className='denied-para'>Please login and Try Again</div>
